...
app.use('/dhcpv4_config', require('./routes/dhcpv4_config'))
app.use('/dhcpv6_config', require('./routes/dhcpv6_config'))
...
app.use('/dhcpv4_config_save', require('./routes/dhcpv4_config_save'))
app.use('/dhcpv6_config_save', require('./routes/dhcpv6_config_save'))
